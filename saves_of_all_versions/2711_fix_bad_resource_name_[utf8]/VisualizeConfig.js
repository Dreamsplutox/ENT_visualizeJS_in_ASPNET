...
function clean_utf8(current_folder_name) {
    var correct_folder_name = "";
    var clean_mode = 0;
    var char_number = "";

    for (i = 0; i < current_folder_name.length; i++) {
        ...
        if (clean_mode == 1 || current_folder_name[i] == "&") {
            ...
            if (current_folder_name[i] == ";") {
                ...
                //alert("CORRECT CHAR " + String.fromCharCode(parseInt(char_number)) + " | " + char_number);
...
current_resource = clean_utf8(current_resource);

console.log("current res : " + current_resource);//current_resource);
            ...
            error: function (error) {
                ...
                var ic = v.inputControls({
                    ...
                    success: function (data) {
                        console.log("------------------------------ SUCCESS FIRST INPUT CONTROL GETTER");
                        console.log(Object.getOwnPropertyNames(data));
                    },
                    error: function (e) {
                        alert("cant get input control");
