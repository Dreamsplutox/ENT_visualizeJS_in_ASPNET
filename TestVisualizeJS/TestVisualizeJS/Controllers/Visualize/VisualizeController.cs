...
namespace TestVisualizeJS.Controllers.Visualize
{
    public class VisualizeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var folder_choice = "path/to/folder";//"/L4_logistics/Conception/rapports_test/copy_reports";//"/L4_logistics/Conception/rapports_test/test/test_mongodb";//was &type=reportunit
            var credentials_jasper = "j_user:j_password"; // Credentials
            ...
            string URL_rest_list_reports = "http://srvreporting-01:8080/jasperserver-pro/rest_v2/resources?folderUri="+folder_choice;
