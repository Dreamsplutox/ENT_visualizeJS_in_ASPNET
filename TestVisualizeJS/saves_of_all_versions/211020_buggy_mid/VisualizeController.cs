...
namespace TestVisualizeJS.Controllers.Visualize
{
    public class VisualizeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var folder_choice = "/L4_logistics/Conception/rapports_test/test/test_mongodb";//"/L4_logistics/Conception/rapports_test/copy_reports";//"/L4_logistics/Conception/rapports_test/test/test_mongodb";//was &type=reportunit
